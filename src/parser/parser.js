...
*/
var parser = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[5,37,40,41,42,43,45,46,47,49,59,61,66,73,77,81,85,89,100,101,104,105,113,116],$V1=[1,37],$V2=[1,35],$V3=[1,38],$V4=[1,39],$V5=[1,40],$V6=[1,58],$V7=[1,41],$V8=[1,42],$V9=[1,44],$Va=[1,45],$Vb=[1,46],$Vc=[1,47],$Vd=[1,48],$Ve=[1,49],$Vf=[1,50],$Vg=[1,51],$Vh=[1,52],$Vi=[1,53],$Vj=[1,54],$Vk=[1,55],$Vl=[1,56],$Vm=[1,57],$Vn=[1,59],$Vo=[1,60],$Vp=[1,61],$Vq=[1,62],$Vr=[1,63],$Vs=[1,65],$Vt=[1,64],$Vu=[5,37,38,40,41,42,43,45,46,47,48,49,50,51,52,53,55,56,58,59,60,61,62,64,66,67,69,73,76,77,78,79,80,81,82,83,84,85,89,90,98,100,101,104,105,106,108,109,112,113,116],$Vv=[5,38,40,50,51,52,53,55,56,58,60,62,64,67,69,76,78,79,80,82,83,84,85,90,98,106,108,109,112],$Vw=[1,66],$Vx=[1,71],$Vy=[1,70],$Vz=[1,75],$VA=[1,76],$VB=[2,45],$VC=[40,55,58,60],$VD=[2,59],$VE=[40,55,58,67],$VF=[1,106],$VG=[1,108],$VH=[2,111],$VI=[1,121],$VJ=[5,37,38,40,41,42,43,45,46,47,49,55,56,58,59,60,61,62,64,66,67,73,76,77,78,79,80,81,82,83,85,89,90,98,100,101,104,105,106,108,109,112,113,116],$VK=[2,123],$VL=[1,127],$VM=[37,41,42,43,45,46,47,49,56,59,61,66,73,77,81,89,100,101,104,105,113,116],$VN=[1,130],$VO=[1,136],$VP=[1,135],$VQ=[37,40,41,42,43,45,46,47,48,49,50,51,52,53,55,58,59,60,61,66,69,73,77,81,84,89,100,101,104,105,113,116],$VR=[2,58],$VS=[1,145],$VT=[108,109,112],$VU=[37,38,40,41,42,43,45,46,47,49,56,59,61,66,73,77,81,89,100,101,103,104,105,113,116],$VV=[40,55,58,60,62,67,78],$VW=[37,41,42,43,45,46,47,49,59,61,66,73,77,81,89,100,101,104,105,113,116],$VX=[1,190],$VY=[40,58],$VZ=[2,85],$V_=[1,200],$V$=[40,45,56,58,74,75],$V01=[37,40,41,42,43,45,46,47,49,58,59,61,66,73,77,81,89,100,101,104,105,113,116],$V11=[40,55,58],$V21=[37,40,41,42,43,45,46,47,49,56,58,59,61,66,73,77,81,89,100,101,104,105,113,116],$V31=[5,37,38,40,41,42,43,45,46,47,48,49,50,51,52,53,55,56,58,59,60,61,62,64,66,67,73,76,77,78,79,80,81,82,83,84,85,89,90,98,100,101,104,105,106,108,109,112,113,116],$V41=[1,244],$V51=[37,40,41,42,43,45,46,47,49,58,59,61,66,73,76,77,81,89,100,101,104,105,113,116],$V61=[1,266],$V71=[1,267];
...
rules: [/^(?:((\r\n|\r|\n)+[ \t]*)?###(.|\r|\n)*?###)/,/^(?:(\r\n|\r|\n)+[ \t]*#.*($|\r\n|\r|\n))/,/^(?:#.*($|\r\n|\r|\n))/,/^(?:\[\s*)/,/^(?:\])/,/^(?:\{\{\s*)/,/^(?:\}\})/,/^(?:\{\s*)/,/^(?:\})/,/^(?:>>=)/,/^(?:<<)/,/^(?:>>)/,/^(?:<\/[^\>]+>)/,/^(?:<\/\s*)/,/^(?:<\s*)/,/^(?:\/>)/,/^(?:>)/,/^(?:(\r\n|\r|\n)+[ \t]+(\r\n|\r|\n))/,/^(?:(\r\n|\r|\n)+[ \t]*)/,/^(?:\s+)/,/^(?:fn\b)/,/^(?:caseof\b)/,/^(?:def\b)/,/^(?:match\b)/,/^(?:end\b)/,/^(?:args\b)/,/^(?:if\b)/,/^(?:incase\b)/,/^(?:throws\b)/,/^(?:else\b)/,/^(?:do\b)/,/^(?:cond\b)/,/^(?:for\b)/,/^(?:in\b)/,/^(?:then\b)/,/^(?:when\b)/,/^(?:where\b)/,/^(?:try\b)/,/^(?:catch\b)/,/^(?:import\b)/,/^(?:export\b)/,/^(?:from\b)/,/^(?:onlyif\b)/,/^(?:and|or|lte|gte|lt|gt\b)/,/^(?:isnt|is|==|!=)/,/^(?:true|false|null|undefined|NaN\b)/,/^(?:(@)?[a-zA-Z\_\$][a-zA-Z0-9\_\$]*((\s*\.\s*)?[a-zA-Z0-9\_\$]+)*)/,/^(?:(-)?[0-9]+(\.[0-9]+)?(e-?[0-9]+)?)/,/^(?:\/[^\/\s]+\/[gim]*)/,/^(?:"([^\"]|\\[\"])*")/,/^(?:'([^\']|\\[\'])*')/,/^(?:`([^\`]|\\[\`])*`)/,/^(?:@)/,/^(?:,)/,/^(?:->)/,/^(?:::)/,/^(?::)/,/^(?:=>)/,/^(?:=)/,/^(?:\.)/,/^(?:\|\|)/,/^(?:\+|-|\*|\/|%)/,/^(?:\()/,/^(?:\))/,/^(?:\|)/,/^(?:!)/,/^(?:$)/],
